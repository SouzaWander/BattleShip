...
Para compilar basta escrever "make QUAD" ou "make MAT" no terminal conforme se queira usar as matrizes (MAT) ou a QuadTree (QUAD).
Para executar escrevemos "./mainQ" para QuadTree ou "./mainM" para matrizes.
